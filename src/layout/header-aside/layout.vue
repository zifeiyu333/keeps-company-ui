    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div class="d2-theme-header" :style="{ opacity: this.searchActive ? 0.5 : 1 }" flex-box="0" flex>
        <router-link
          ...
          flex-box="0">
          <!-- <div v-if="asideCollapse" style="height:70px; line-height:70px;text-align: center;font-size: 30px">票据</div>
          <div v-else style="height:70px; line-height:70px;text-align: center;font-size: 30px">票据管理</div> -->
