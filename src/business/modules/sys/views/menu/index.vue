  ...
  <d2-container :class="{'page-compact':crud.pageOptions.compact}">
    ...
    >
      ...
      <div slot="header">
        ...
        <el-button slot="header"  v-permission="'sys:menu:add'" size="small" type="primary" @click="addRootRow"><i class="el-icon-plus"/> 新增</el-button>
...
export default {
  ...
  methods: {
    ...
    handleAddSubResource ({ index, row }) {
      this.addRow({ parentId: row.menuId })
    },
    addRootRow () {
